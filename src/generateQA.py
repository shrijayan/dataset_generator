...
class GenerateQA:
    ...
    def generate_chunk_questions(self, content):
        ...
        {"question": "What if I withdraw less than the eligible amount for Overdraft Against Fixed Deposit?"
        For Example if you're eligible for an overdraft of Rs 85,000 but withdraw only Rs 50,000, you'll be charged interest only on Rs 50,000.}
